...
extern "C" {
    ...
    #[wasm_bindgen(method, getter)]
    pub fn input(this: &ReadLineOptions) -> ReadableStream;
    #[wasm_bindgen(method, setter)]
    pub fn set_input(this: &ReadLineOptions, value: &ReadableStream);
    #[wasm_bindgen(method, getter)]
    pub fn output(this: &ReadLineOptions) -> Option<WritableStream>;
    #[wasm_bindgen(method, setter)]
    pub fn set_output(this: &ReadLineOptions, value: Option<&WritableStream>);
    #[wasm_bindgen(method, getter)]
