...
impl AsRef<EventEmitter> for ChildProcess {
    fn as_ref(&self) -> &EventEmitter {
        JsCast::unchecked_ref(self)
    }
}
impl From<ChildProcess> for EventEmitter {
...
impl AsRef<EventEmitter> for ChildProcessByStdio {
    fn as_ref(&self) -> &EventEmitter {
        JsCast::unchecked_ref(self)
    }
}
impl From<ChildProcessByStdio> for EventEmitter {
    fn from(child: ChildProcessByStdio) -> Self {
        JsCast::unchecked_into(child)
    }
}
...
impl AsRef<EventEmitter> for ChildProcessWithoutNullStreams {
    fn as_ref(&self) -> &EventEmitter {
        JsCast::unchecked_ref(self)
    }
}
