...
extern "C" {
    ...
    #[wasm_bindgen(method)]
    pub fn unpipe(this: &Readable, destination: Option<&node_js::WritableStream>) -> Readable;
    #[wasm_bindgen(method, setter)]
    ...
    #[wasm_bindgen(method)]
    pub fn wrap(this: &Readable, old_stream: &node_js::ReadableStream) -> Readable;
    #[wasm_bindgen(method, setter)]
    ...
    pub fn pipeline4(
        ...
        stream2: &node_js::ReadWriteStream,
        stream3: &node_js::ReadWriteStream,
        stream4: &node_js::ReadWriteStream,
        stream5: &JsValue,
        callback: &JsValue,
    ) -> JsValue;
    # [ wasm_bindgen ( js_name = pipeline ) ]
