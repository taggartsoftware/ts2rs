...
extern "C" {
    ...
    #[wasm_bindgen(method, getter)]
    pub fn input(this: &ReplOptions) -> Option<ReadableStream>;
    #[wasm_bindgen(method, setter)]
    pub fn set_input(this: &ReplOptions, value: Option<&ReadableStream>);
    #[doc = "The `Writable` stream to which REPL output will be written."]
    #[doc = "Default: `process.stdout`"]
    #[wasm_bindgen(method, getter)]
    pub fn output(this: &ReplOptions) -> Option<WritableStream>;
    #[wasm_bindgen(method, setter)]
    pub fn set_output(this: &ReplOptions, value: Option<&WritableStream>);
    ...
    pub fn input_stream(this: &REPLServer) -> ReadableStream;
    #[doc = "The `Writable` stream to which REPL output will be written."]
    # [ wasm_bindgen ( method , getter , js_name = outputStream ) ]
    pub fn output_stream(this: &REPLServer) -> WritableStream;
